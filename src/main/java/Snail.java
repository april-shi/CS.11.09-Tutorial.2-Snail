...
public class Snail {
     ...
     * Output: a 1d array of length n^2 that contains the order of
     * elements visited in a snail traversal of the 2d array.
     *
     * Example:
     *
     * Input:
     ...
     * @return
     */
    public static boolean isPerfectSquare(int[][] array2d) {
